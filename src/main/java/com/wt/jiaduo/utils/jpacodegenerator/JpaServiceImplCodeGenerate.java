package com.wt.jiaduo.utils.jpacodegenerator;
 ...
 *
 */
public class JpaServiceImplCodeGenerate {
	public static void main(String[] args) throws IOException {
		String targetFolderPathString="/Users/wu/eclipse-workspace/jiaduo/src/main/java/com/wt/jiaduo/service/impl";
		...
		String readFileTemplatePathString=targetFolderPathString+"/XiaomaiTiaoxiubingZaoqiServiceImpl.java";
		for(String className:classNames) {
			String targetFileNamePathString=targetFolderPathString+"/"+className+"ServiceImpl.java";
