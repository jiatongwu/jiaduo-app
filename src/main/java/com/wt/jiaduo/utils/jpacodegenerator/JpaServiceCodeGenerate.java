 ...
 *
 */
public class JpaServiceCodeGenerate {
	public static void main(String[] args) throws IOException {
		String targetFolderPathString="/Users/wu/eclipse-workspace/jiaduo/src/main/java/com/wt/jiaduo/service";
		...
		String readFileTemplatePathString=targetFolderPathString+"/XiaomaiTiaoxiubingZaoqiService.java";
		for(String className:classNames) {
			String targetFileNamePathString=targetFolderPathString+"/"+className+"Service.java";
