 ...
 *
 */
public class JpaControllerCodeGenerate {
	public static void main(String[] args) throws IOException {
		String targetFolderPathString="/Users/wu/eclipse-workspace/jiaduo/src/main/java/com/wt/jiaduo/controller";
		...
		String readFileTemplatePathString=targetFolderPathString+"/XiaomaiTiaoxiubingZaoqiController.java";
		for(String className:classNames) {
			String targetFileNamePathString=targetFolderPathString+"/"+className+"Controller.java";
