...
public class XiaomaiYexiubing implements java.io.Serializable {
	...
	public XiaomaiYexiubing() {
	}

	public XiaomaiYexiubing(String place, String person, Date dateTime, String serialNumber, String variety,
