...
public class XiaomaiBaifenbingAddValid implements java.io.Serializable {
	...
	public XiaomaiBaifenbingAddValid() {
	}

	public XiaomaiBaifenbingAddValid(Date dateTime, String place, String person, String varietyName, String sowingDate,
