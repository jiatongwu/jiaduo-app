...
public class XiaomaiChimeibingAddValid implements java.io.Serializable {
	...
	public XiaomaiChimeibingAddValid() {
	}

	public XiaomaiChimeibingAddValid(Date dateTime, String person, String place, String pinzhong, String leixingtian,
