...
public class XiaomaiTiaoxiubingHouqiAddValid implements java.io.Serializable {
	...
	public XiaomaiTiaoxiubingHouqiAddValid() {
	}

	public XiaomaiTiaoxiubingHouqiAddValid(String place, String person, Date dateTime, String variety, String fieldNum,
